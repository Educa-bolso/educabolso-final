...
export default Yup.object().shape({
    nome: Yup.string().min(3, "Digite no mínimo 3 caracteres").required("Por favor, digite um nome"),
    sobrenome: Yup.string().required("Digite o Sobrenome"),
    email: Yup.string().email("Digite um e-mail válido").required("Por favor, digite um e-mail"),
